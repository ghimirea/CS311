...
describe("LinkedList", function () {
    ...
    describe("Binary Search", function () {
        ...
        it("1 is in the list", function () {

            assert.equal(linkedList.contains(1), 2);
        });
        it("5 is in the list", function () {
            assert.equal(linkedList.contains(5), 0);
        });
        it("10 is not in the list", function () {
            assert.equal(linkedList.contains(10), -1);
        });
    });
});