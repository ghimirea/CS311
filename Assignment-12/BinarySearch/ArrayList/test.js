...
describe("ArrayList", function () {
    ...
    describe("Binary Search", function () {
        ...
        it("tiny is in the array", function () {
            
            assert.equal(arrayList.contains("tiny"), 1);
        });
        it("finds the last element in the array", function () {
            assert.equal(arrayList.contains("big"), -1);
        });
        it("number is not in the list", function () {
            assert.equal(arrayList.contains("number"), -1);
        });
    });
});
